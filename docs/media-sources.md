...
Organization popups use **Unicode emojis** for visual representation. Each organization is assigned a contextually relevant emoji (e.g., 🌍 for global organizations, 🌿 for conservation, 🐾 for wildlife).
...
- Department of Climate Change, Energy & Environment: https://www.dcceew.gov.au
...
- Sunita Narain: https://en.wikipedia.org/wiki/Sunita_Narain

## Case Studies

Case-study images are embedded from Wikimedia Commons / Wikipedia media associated with these pages:

- Geothermal power: https://en.wikipedia.org/wiki/Geothermal_power
- Kigali: https://en.wikipedia.org/wiki/Kigali
- Hammarby Sjostad: https://en.wikipedia.org/wiki/Hammarby_Sj%C3%B6stad
- Solar power in India: https://en.wikipedia.org/wiki/Solar_power_in_India
- Renewable energy in Germany: https://en.wikipedia.org/wiki/Renewable_energy_in_Germany
...
- Saihanba National Forest Park: https://en.wikipedia.org/wiki/Saihanba_National_Forest_Park

## Licensing & Attribution

### Emojis (Organizations)
- Unicode emojis used for organization icons are freely available and don't require attribution
...
When repurposing Wikipedia images for publication:
1. Check the specific license on the Wikimedia Commons image page
2. Include proper attribution (author and license) if required by CC-BY or CC-BY-SA
3. Link to the original Wikimedia Commons page when possible
